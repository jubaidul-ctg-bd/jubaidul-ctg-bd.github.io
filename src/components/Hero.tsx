    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-6">
        ...
        >
          ...
          >
            Building robust, scalable applications with expertise in Node.js, TypeScript, 
            and cloud infrastructure. Passionate about clean architecture and high-performance systems.
          </motion.p>
